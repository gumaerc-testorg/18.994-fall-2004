...
Minimal Surfaces as Isotropic Curves in C{{< sup "3" >}}: Associated minimal surfaces and the Bjoorling's problem ([PDF-2.2MB]({{< baseurl >}}/resources/main1)) (Courtesy of Kai-Wing Fung. Used with permission.)
